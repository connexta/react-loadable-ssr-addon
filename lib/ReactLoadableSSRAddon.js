...
var ReactLoadableSSRAddon = function () {
  ...
  _proto.writeAssetsFile = function writeAssetsFile(callback) {
    ...
    this.compiler.outputFileSystem.writeFile(this.options.filename, json, callback);
  };

  _proto.mkDirByPathSync = function mkDirByPathSync(targetDir, fs, _temp) {
    var _ref2 = _temp === void 0 ? {} : _temp,
        _ref2$isRelativeToScr = _ref2.isRelativeToScript,
        isRelativeToScript = _ref2$isRelativeToScr === void 0 ? false : _ref2$isRelativeToScr;
