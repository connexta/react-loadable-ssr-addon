...
var ReactLoadableSSRAddon = (function() {
      ...
      for (var _i = 0; _i < files.length; _i += 1) {
        ...
        if (!(0, _utils.hasEntry)(assets[id][ext], "file", file)) {
          var shouldComputeIntegrity =
            ...
            _this.options.integrity &&
            !currentAsset[_this.options.integrityPropertyName];

          if (shouldComputeIntegrity) {
            currentAsset[_this.options.integrityPropertyName] = (0,
            _utils.computeIntegrity)(
              _this.options.integrityAlgorithms,
              currentAsset.source()
            );
          }
  ...
  _proto.writeAssetsFile = function writeAssetsFile() {
    var fileDir = _path["default"].dirname(this.options.filename);
    ...
    console.log("Writing bundle manifest to disk: " + this.options.filename);
  ...
  _proto.mkDirByPathSync = function mkDirByPathSync(targetDir, fs, _temp) {
    var _ref2 = _temp === void 0 ? {} : _temp,
      _ref2$isRelativeToScr = _ref2.isRelativeToScript,
      isRelativeToScript =
        _ref2$isRelativeToScr === void 0 ? false : _ref2$isRelativeToScr;
    ...
    return targetDir.split(sep).reduce(function(parentDir, childDir) {
      ...
      try {
        ...
        if (
          !caughtErr ||
          (caughtErr && curDir === _path["default"].resolve(targetDir))
        ) {
          throw err;
        }
      }
